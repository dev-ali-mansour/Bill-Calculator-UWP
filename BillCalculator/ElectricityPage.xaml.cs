...
namespace BillCalculator
{
    ...
    public sealed partial class ElectricityPage : Page
    {
        ...
        {
            Electricity.GetAmount(IsHomeToggleSwitch, PreviousTextBox, CurrentTextBox, MonthsTextBox, ref ConsumptionTextBlock, ref AmountTextBlock);
        }
        ...
        private void IsHomeToggleSwitch_Toggled(object sender, RoutedEventArgs e)
        {
            Calculate();
        }
